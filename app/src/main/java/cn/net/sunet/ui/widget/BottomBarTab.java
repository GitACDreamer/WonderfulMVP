package cn.net.sunet.ui.widget;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        LayoutParams paramsContainer = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams
                .WRAP_CONTENT);
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.tab_bg_msg_bubble);
        ...
        LayoutParams tvUnReadParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                min);
